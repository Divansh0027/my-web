...
import { Property, Testimonial } from '@/shared/types/types'
...
export const SAMPLE_PROPERTIES: Property[] = [
  ...
  },
  {
    ...
    description:
      'An architectural masterpiece in the heart of Millennium City. This bespoke under-construction 4 BHK luxury villa offers double-height lounge ceilings, an ultra-modern private plunge pool, and expansive landscaped rooftop decks. Perfectly finished with high-end fixtures, internal marble architecture, triple-tier intelligent home automation, and dedicated rooms for domestic staff. Set inside a highly secure premier township in Gurugram Sector 57, offering deep tranquility alongside instant access to Sector 56 Metro and Golf Course Road.',
    price: 28000000,
...
export const TESTIMONIALS: Testimonial[] = [
  {
    ...
    rating: 5,
    reviewText:
      'Shiv Saya Properties guided me through purchasing my first ever home in Dwarka Sector 10. Outstanding professional ethics, completely transparent RERA details, and zero hidden costs. Highly recommend!',
  ...
  },
  {
    ...
    rating: 5,
    reviewText:
      'Excellent command over the local Gurugram market. They helped me compare builder track records and secure a fantastic deal on our luxury sector 57 villa. Exceptional paperwork support.',
  ...
  },
  {
    ...
    rating: 5,
    reviewText:
      'I was looking for a high-occupancy commercial investment in Noida Sector 18. Their advisory team identified a ground floor shop that is already yielding incredible rents. Pure professionals.',
...
export const SERVICES = [
  {
    ...
    description:
      'Explore premium Apartments, luxury villas, and private builder floors across prime neighborhoods.',
  },
  {
    id: 's-2',
    icon: 'Building',
    ...
    description:
      'Invest in high-footfall retail shops, Grade-A office spaces, and commercial showrooms.',
  },
  {
    id: 's-3',
    icon: 'Layers',
    ...
    description:
      'Hassle-free corporate rentals, family apartments, and luxury stays with strict agreement verification.',
  },
  {
    id: 's-4',
    icon: 'Compass',
    ...
    description:
      'Maximize your portfolio with RERA approved, high-growth prospective markets in Delhi NCR.',
  },
  {
    id: 's-5',
    icon: 'Building',
    ...
    description:
      'Secure modern independent floor properties with private staircases, stilt parking, and premium building.',
  },
  {
    id: 's-6',
    icon: 'MapPin',
    title: 'Plots & Land',
    description:
      'Invest in freehold residential or industrial plots inside secure gated residential societies.',
  },
  {
    id: 's-7',
    icon: 'Sliders',
    ...
    description:
      'End-to-end guidance through title deed registry, conversion certificates, RERA forms, and sales deeds.',
  },
  {
    id: 's-8',
    icon: 'Award',
    ...
    description:
      'Accurate comparative market analysis of your land, apartment, or commercial setups.',
  },
  {
    id: 's-9',
    icon: 'ShieldCheck',
    ...
    description:
      "Fast-track documentation for bank loans matching with India's leading banks at the lowest interest rates.",
  },
]
...
export const WHY_CHOOSE_US = [
  {
    ...
    description:
      'With 10+ years of micro-market data across Delhi, Gurugram, and Noida, we know how to secure the best pricing for you.',
  },
  {
    id: 'w-2',
    iconName: 'BadgeCheck',
    ...
    description:
      'No false listings. Every listing on our platform undergoes a rigorous physical and legal ownership check by our team.',
  },
  {
    id: 'w-3',
    iconName: 'Shield',
    ...
    description:
      'From initial high-definition viewings to final key handovers, registry documentation, and bank loans — we cover it all.',
  },
  {
    id: 'w-4',
    iconName: 'FileText',
    ...
    description:
      '100% compliant with Delhi and Haryana RERA laws. Our advisory is fully ethical, contractually defined, and transparent.',
  },
]
