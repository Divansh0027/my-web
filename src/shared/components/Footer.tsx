...
export default React.memo(function Footer() {
  ...
  useEffect(() => {
    const unsubscribe = subscribeRemoteControls((controls: any) => {
    ...
    <>
      ...
      <footer className="bg-surface-container-low border-t border-outline-variant/50 font-sans relative pt-16 pb-8 text-on-surface-variant">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
            ...
            <div className="space-y-5">
              ...
              <p className="text-sm leading-relaxed text-on-surface-variant">
                {BUSINESS_CONFIG.businessName} is Delhi NCR's premium real estate advisory. Guided
                by lead consultant <strong>{BUSINESS_CONFIG.consultantName}</strong>, we combine
                expert market analytics with transparent client-focused guidance.
              </p>
              ...
              <div className="flex items-center gap-3">
                <button
                  ...
                  className="h-9 w-9 bg-surface-container-high/60 hover:bg-gold-accent hover:text-[var(--on-gold)] rounded-full flex items-center justify-center text-on-surface-variant transition-all cursor-default"
                >
              ...
              <ul className="space-y-3.5 text-sm">
                <li>
                  <Link
                    ...
                    className="hover:text-gold-accent transition-colors text-left inline-block"
                  >
                    Home
                  </Link>
                </li>
                ...
                <li>
                  <button
                    ...
                    className="hover:text-gold-accent transition-colors text-left inline-flex items-center gap-2 mt-2"
                  >
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-3 text-sm">
                ...
                <p className="text-on-surface-variant">
                  NH 58, Morta Rajnagar Extension,
                  <br />
                  Ghaziabad, Uttar Pradesh
                  <br />
                  Near Duhai RRTS Metro Station
                  <br />
                  (Pillar Number 711)
                </p>
              </div>
              ...
              <div className="flex gap-3 items-center text-sm">
                ...
                <a
                  ...
                  className="hover:text-gold-accent transition-colors text-on-surface-variant"
                >
              ...
              <div className="flex gap-3 items-center text-sm">
                <span className="text-[10px] font-bold px-2 py-0.5 bg-gold-accent/10 text-gold-accent rounded border border-gold-accent/20 uppercase">
                  Consultant
                </span>
              ...
              <div className="flex gap-3 items-center text-sm">
                ...
                <a
                  ...
                  className="hover:text-gold-accent transition-colors text-on-surface-variant break-all"
                >
          ...
          {/* Separator */}
          <div className="border-t border-outline-variant/50 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-on-surface-variant">
            <div>
            ...
            <div className="flex items-center gap-6">
              <button
                onClick={() => {}}
                className="hover:text-on-surface transition-colors cursor-default"
              >
                Privacy Policy
              </button>
              <button
              ...
              <button
                ...
                className="h-9 w-9 bg-surface-container-high hover:bg-gold-accent hover:text-[var(--on-gold)] text-on-surface-variant rounded-full flex items-center justify-center transition-all shadow-md ml-2"
                title="Return to top"
              >
