      ...
      <div className="space-y-6 animate-fadeIn md:text-left text-xs text-on-surface-variant">
        <div>
          ...
          <p className="text-xs text-on-surface-variant">
            Modify global credentials list, toggle simulated variables, or reset database snapshots.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <form
            ...
            className="bg-surface-container border border-outline-variant/50 rounded-2xl p-5 shadow-md space-y-4"
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label
                  htmlFor="auto-adminview-1744"
                  className="text-[10px] uppercase font-bold tracking-wider text-on-surface-variant"
                >
                  Business Name
                </label>
                <input
                  id="auto-adminview-1744"
                  type="text"
              ...
              <div className="space-y-1.5">
                <label
                  htmlFor="admin-settings-rera"
                  className="text-[10px] uppercase font-bold tracking-wider text-on-surface-variant"
                >
                  RERA Number
                </label>
                <input
                  id="admin-settings-rera"
                  type="text"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-1.5">
                <label
                  htmlFor="admin-settings-consultant"
                  className="text-[10px] uppercase font-bold tracking-wider text-on-surface-variant"
                >
                  Consultant Lead
                </label>
                <input
                  id="admin-settings-consultant"
                  type="text"
              ...
              <div className="space-y-1.5">
                <label
                  htmlFor="admin-settings-whatsapp"
                  className="text-[10px] uppercase font-bold tracking-wider text-on-surface-variant"
                >
                  WhatsApp Target
                </label>
            ...
            <div className="space-y-1.5">
              <label
                htmlFor="admin-settings-addr"
                className="text-[10px] uppercase font-bold tracking-wider text-on-surface-variant"
              >
                Office Headquarters Physical Address
              </label>
              <input
                id="admin-settings-addr"
                type="text"
            ...
            <button
              type="submit"
              className="w-full mt-2.5 py-3 rounded-xl bg-gold-accent text-[var(--on-gold)] font-black cursor-pointer shadow active:scale-98 hover:bg-gold-hover hover:scale-105 shadow-md transition-all font-sans"
            >
          ...
          <div className="space-y-6">
            ...
            <div className="bg-surface-container border border-outline-variant/50 rounded-2xl p-5 shadow-md space-y-4">
              ...
              <form onSubmit={handleAddAdmin} className="flex gap-2">
                ...
                <input
                  ...
                  className="flex-grow bg-surface border border-outline-variant/50 focus:border-gold-accent/30 rounded-xl px-3 py-2 text-xs text-on-surface placeholder-on-surface-variant outline-none"
                  required
                />
                <button
                  type="submit"
              ...
              <p className="text-[10px] text-on-surface-variant italic mt-1 mb-2 leading-tight">
                If the user hasn't signed up yet, their admin access will activate automatically
            ...
            <div className="bg-surface-container border border-outline-variant/50 rounded-2xl p-5 shadow-md space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                {[
                  {
                    key: 'offlineMaintenance',
                    label: 'Maintenance',
                    desc: 'Block frontend routing',
                  },
                  {
                    key: 'slowOperations',
                    label: 'Slow Ops (1s)',
                    desc: 'Simulate throttle latency',
                  },
                  {
                    key: 'showWhatsappFloating',
                    label: 'WhatsApp Btn',
                    desc: 'Floating help widget',
                  },
                  {
                    key: 'autoApproveListings',
                    label: 'Auto Approve',
                    desc: 'Skip admin audit checks',
                  },
                ].map((ctl) => {
                  ...
                  return (
                    <div
                      key={ctl.key}
                      className="p-3 bg-slate-955/40 border border-outline-variant/50 rounded-xl flex items-center justify-between gap-2"
                    >
                      <div>
                        <span className="font-extrabold text-on-surface block text-[10.5px] leading-snug">
                          {ctl.label}
                        </span>
                        <span className="text-[8.5px] text-on-surface-variant mt-0.5 block leading-none font-medium">
                          {ctl.desc}
                        </span>
                      </div>
