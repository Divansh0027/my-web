      ...
      <div className="space-y-6 animate-fadeIn">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            <h1 className="text-xl font-extrabold text-on-surface tracking-tight">
              Client Contact Hub ({filteredEnquiries.length} records)
            </h1>
            <p className="text-xs text-on-surface-variant">
              Direct callbacks from interested buyers. Complete tasks, change statuses, or chat on
              WhatsApp.
            </p>
          </div>
        ...
        <div className="bg-surface-container border border-outline-variant/50 rounded-2xl p-4 flex flex-col sm:flex-row gap-3.5 shadow-md">
          <div className="flex-1 relative">
            ...
            <label htmlFor="search-enquiries-input" className="sr-only">
              Search Enquiries
            </label>
            <input
              id="search-enquiries-input"
              type="text"
              placeholder="Search enquiries by name, email, or property title..."
              value={enquirySearch}
              onChange={(e) => setEnquirySearch(e.target.value)}
              className="w-full bg-surface border border-outline-variant/50 focus:border-gold-accent/40 rounded-xl pl-10 pr-4 py-2 text-xs text-on-surface placeholder-on-surface-variant outline-none transition-all"
            />
          </div>
                    ...
                    >
                      ...
                      <td className="py-4 px-4 space-y-1">
                        ...
                        <p className="text-[9px] text-on-surface-variant">
                          Recd: {new Date(enq.dateStr).toLocaleDateString()}
                        </p>
                      </td>
                      ...
                      <td className="py-4 px-4 max-w-sm">
                        <p className="text-[11px] text-on-surface-variant leading-relaxed font-sans font-medium whitespace-pre-wrap">
                          "{enq.message}"
                        </p>
                      </td>
                      ...
                      <td className="py-4 px-4">
                        <div className="flex items-center justify-center gap-1.5">
                          ...
                          <a
                            ...
                            aria-label="WhatsApp Specialist Chat"
                          >
