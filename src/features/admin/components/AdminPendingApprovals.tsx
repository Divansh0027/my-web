  ...
  return (
    <>
      <div className="space-y-6 animate-fadeIn">
        <div>
          <h2 className="text-xl text-on-surface font-extrabold tracking-tight">
            Pending Approvals Queue
          </h2>
          <p className="text-xs text-on-surface-variant font-medium">
            Explicit listing of all records lacking physical validation or compliance audit.
          </p>
        </div>
                      ...
                      <td className="py-4 px-4">
                        <div className="flex items-center justify-center gap-2">
                          <button
                            ...
                            className="px-3 py-1.5 rounded-lg bg-gold-accent hover:bg-gold-hover text-[var(--on-gold)] font-black text-[10px] flex items-center gap-1 cursor-pointer transition-all focus:ring-2 ring-gold-accent/50"
                            title="Audit Approve"
                            aria-label="Audit Approve"
                          >
