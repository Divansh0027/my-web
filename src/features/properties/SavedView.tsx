      ...
      <div className="bg-surface-container border-b border-outline-variant/50 py-10 px-4 sm:px-6 lg:px-8 mb-10">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-on-surface-variant text-xs mt-2 font-medium">
            Manage your favorited properties in one clear place. Connect with advisors for joint
            group site tours.
          </p>
        </div>
      </div>
        ...
        {isLoadingData ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[...Array(3)].map((_, i) => (
              <div
                key={i}
                className="bg-surface-container border border-outline-variant/50 rounded-2xl p-4 space-y-4 animate-pulse"
              >
          ...
          <div className="text-center py-20 bg-surface-container/40 border border-outline-variant/50 rounded-3xl max-w-lg mx-auto p-8">
            ...
            {user ? (
              <button
                ...
                className="px-6 py-3 bg-gold-accent text-[var(--on-gold)] text-xs font-bold rounded-xl shadow hover:bg-gold-hover hover:scale-105 shadow-md"
              >
                ...
                <div className="p-5 flex-1 flex flex-col justify-between">
                  <div>
                    ...
                    <div className="grid grid-cols-2 gap-4 py-4 text-xs text-on-surface-variant">
                      ...
                      <div className="flex items-center gap-1.5 justify-end">
                        <Maximize className="h-4 w-4 text-on-surface-variant" />
                        <span>
                  ...
                  <div className="flex items-center gap-2.5 mt-2 pt-2 border-t border-outline-variant/50">
                    ...
                    <a
                      ...
                      aria-label={`Discuss ${prop.title} on WhatsApp`}
                    >
