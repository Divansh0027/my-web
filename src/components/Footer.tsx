    ...
    <footer className="bg-[#0b0f19] border-t border-white/5 font-sans relative pt-16 pb-8 text-slate-300">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div className="space-y-5">
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              Shiv Saya Properties is Delhi NCR's premium real estate advisory. Guided by lead consultant <strong>Ritik Khari</strong>, we combine expert market analytics with transparent client-focused guidance.
            </p>
            ...
            <div className="pt-2">
              <span className="inline-block bg-[#D4AF37]/10 text-[#D4AF37] text-xs font-semibold px-3 py-1.5 rounded-md border border-[#D4AF37]/30">
                RERA Reg. No: RERA-DELHI-NCR-40192B
              </span>
            </div>
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 items-center text-sm">
              ...
              <a href="tel:+919911690027" className="hover:text-[#D4AF37] transition-colors text-slate-400">
                +91 99116 90027
              </a>
            </div>
            ...
            <div className="flex gap-3 items-center text-sm">
              ...
              <p className="text-slate-300 font-semibold text-xs">Ritik Khari</p>
            </div>

            <div className="flex gap-3 items-center text-sm">
              <Mail className="h-4.5 w-4.5 text-[#D4AF37] shrink-0" />
              <a href="mailto:info@shivsayaproperties.com" className="hover:text-[#D4AF37] transition-colors text-slate-400 break-all">
                info@shivsayaproperties.com
              </a>
            </div>
          </div>
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          ...
          <div>
            © 2025 Shiv Saya Properties. All Rights Reserved. | RERA Reg. No: [RERA-DELHI-NCR-XXXX]
          </div>
      ...
      <a
        href="https://wa.me/919911690027?text=Hi%20Shiv%20Saya%20Properties,%20I'd%20love%20to%20get%20more%20details%20about%20your%20premium%20RERA%20properties!"
        target="_blank"
        rel="noreferrer"
