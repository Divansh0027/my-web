...
export default class ErrorBoundary extends React.Component<Props, State> {
  ...
  public render() {
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-surface text-on-surface font-sans flex items-center justify-center p-6 selection:bg-gold-accent/30">
          ...
          <div className="max-w-xl w-full bg-surface-container border border-outline-variant/50 rounded-3xl p-8 sm:p-10 shadow-md relative overflow-hidden space-y-8">
            ...
            <div className="flex flex-col items-center text-center space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <h1 className="text-2xl font-black text-on-surface tracking-tight">Portal Render Interruption</h1>
            ...
            <div className="bg-surface border border-outline-variant/50 rounded-2xl p-4 space-y-2">
              <div className="text-[10px] font-bold text-outline uppercase tracking-wider flex items-center gap-1.5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-3 pt-2">
              <button
                ...
                className="w-full py-3 bg-gold-accent hover:bg-gold-hover hover:scale-105 shadow-md text-[#0F172A] rounded-xl text-xs font-bold flex items-center justify-center gap-2 cursor-pointer transition-all active:scale-98 shadow-md"
              >
