cat > src/features/admin/components/AdminOverview.tsx << 'FILE'
...
import { useAdminPropertiesQuery, useAdminCountsQuery, useAdminPendingPropertiesQuery } from "@/features/admin/hooks/useAdminPropertiesQuery"
